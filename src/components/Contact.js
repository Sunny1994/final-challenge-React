...
const Contact = ({ contact, contactKey }) => {
  ...
  const deleteContact = () => {
    //TODO: create this method from firebase, there will always 
    //be a key which gets created along with the contact, and we remove the contact with the contactkey
    
    remove(ref(db, `contacts/${contactKey}`))
    .then(()=>{
      toast("deleted successfully baby", {type:"success"})
